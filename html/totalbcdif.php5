...
<head>
    <link rel='stylesheet' />
    <script type="text/javascript" src="js/totalbcdif.js"></script>
</head>
<body>
<div class="container">
    <div id="ajudaBC" class="modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>Rejeição 531 - Total Base de Cálculo difere da soma dos itens</h3>
                    <hr/>
                    <p>Preencher os dados da nota e enviar o formulário. Será verificado se existem itens com valor de
                        ICMS onde o CST não corresponde com um tributável. Será recalculado o valor do ICMS e inserido
                        o CST 000 (tributável) nesses itens.</p>
    ...
    <div class="titulo">
        <h2><b>Rejeição 531 <small>- Total BC Difere dos Itens</small></b>
            <button class='btn btn-primary glyphicon glyphicon-question-sign' data-toggle='modal' data-target='#ajudaBC' style='float:right;'> Ajuda</button>
        </h2>
    </div>
    <form method='POST'>
        <div class="row">
    ...
    <div>
        ...
        if( isset($_REQUEST['loja']) && empty ($_REQUEST['loja'])==false && isset($_REQUEST['loja'])>0 &&	//aqui é para não deixar escolher opção default NENHUM
            ...
            $conect= new ClassBD();
            $conect->totalBcDif($loja,$serie,$nota);
        }
        ?>
    </div>
    <div id="5"></div>
