...
<head>
    <link rel='stylesheet' />
    <script type="text/javascript" src="js/fcpinvalido.js"></script>
</head>
<body>
<div class="container">
    <div id="ajudaFCP" class="modal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>Rejeição 874 - FCP Inválido</h3>
                    <hr/>
                    <p>Preencher os dados da nota e enviar o formulário. Será verificado os itens
                        que estão com FCP inválido e os campos necessários serão modificados de forma a retirar os valores de FCP.</p>
    ...
    <div class="titulo">
        <h2><b>Rejeição 874 <small>- FCP Inválido</small></b>
            <button class='btn btn-primary glyphicon glyphicon-question-sign' data-toggle='modal' data-target='#ajudaFCP' style='float:right;'> Ajuda</button>
        </h2>
    </div>
    <form method='POST'>
        <div class="row">
    ...
    <div>
        ...
        if( isset($_REQUEST['loja']) && empty ($_REQUEST['loja'])==false && isset($_REQUEST['loja'])>0 &&
            ...
            $conect= new ClassBD();
            $conect->fcpInvalido($loja,$serie,$nota);
        }
        ?>
